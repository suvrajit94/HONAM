...
def run_single():
    ...
    # train
    model = MLPRegressor(hidden_layer_sizes=(32,64,32), batch_size=3, learning_rate='adaptive', learning_rate_init=0.001, max_iter=1000, early_stopping=True, validation_fraction=0.2, tol=0.001, alpha=0.0001)
